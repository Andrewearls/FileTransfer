...
import shutil, tkinter.filedialog, sqlite3, db_program
from tkinter import *
...
#Finds the path from and to then copies files that are new and leaves old files
    def but1(self):
        ...
        #self.lastcp = self.curtime - datetime.strptime(self.lastcp, '%Y-%m-%d %H:%M:%S.%f')
    ...
    def but2(self):
        ...
        outdir = r"C:\Users\Owner\Desktop\B\\"           #Dir to backup formatted to add file extention
        out = os.listdir(r"C:\Users\Owner\Desktop\B")    #Dir to backup formatted for the for loop
    ...
    def but3(self):
        ...
        dirpath=filedialog.askdirectory(parent=win,initialdir="/",title='Please select a directory')
